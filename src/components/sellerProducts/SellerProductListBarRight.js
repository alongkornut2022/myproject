function SellerProductListBarRight({ handleOnClickSortProduct }) {
  return (
    <>
      <div className="orderresult_container_item_listbar_right">
        ...
        <div className="orderresult_container_item_listbar_item3">
          <div className="orderresult_container_item_listbar_title">
            ...
            <div className="orderresult_container_item_listbar_icon">
              <button
                onClick={() => handleOnClickSortProduct('ps.stock_start')}
              >
                <i class="fa-solid fa-chevron-down"></i>
              </button>
            </div>
        ...
        <div className="orderresult_container_item_listbar_item4">
          <div className="orderresult_container_item_listbar_title">
            ...
            <div className="orderresult_container_item_listbar_icon">
              <button
                onClick={() => handleOnClickSortProduct('ps.alreadysold')}
              >
                <i class="fa-solid fa-chevron-down"></i>
              </button>
            </div>
...
export default SellerProductListBarRight;
